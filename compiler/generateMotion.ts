...
export function generateMotion(config: DesignSystemConfig): GeneratedFile[] {
  return [
    {
      relativePath: "motion/rules.ts",
...
export const motionRules = deepFreeze(${JSON.stringify(config.motion, null, 2)} as const);
`
    },
    {
      relativePath: "motion/index.ts",
      content: `// GENERATED FILE - DO NOT EDIT DIRECTLY.
export { motionRules } from "./rules.js";
`
    }
  ];
}
